            ...
            <div className="max-w-md w-full relative z-10">
                ...
                <div className="rounded-3xl shadow-2xl p-10 border border-white/10 bg-white/5 backdrop-blur-2xl">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-indigo-200/80 text-sm font-medium tracking-wide">Join MeetBuddy AI today</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-1.5">
                            <label htmlFor="name" className="block text-sm font-medium text-indigo-100/90 ml-1">
                                Full Name
                            </label>
                            <div className="relative group/input">
                                <UserIcon className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-indigo-300/50 group-focus-within/input:text-indigo-400 transition-colors" />
                                <input
                                    id="name"
                                    type="text"
                                    value={name}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <p className="text-xs text-indigo-200/50 ml-1 mt-1">Must be at least 6 characters long.</p>
                        </div>

                        <div className="space-y-1.5">
                            <label htmlFor="confirmPassword" className="block text-sm font-medium text-indigo-100/90 ml-1">
                                Confirm Password
                            </label>
                            <div className="relative group/input">
                                <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-indigo-300/50 group-focus-within/input:text-indigo-400 transition-colors" />
